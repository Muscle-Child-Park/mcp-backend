...
public class QTicket extends EntityPathBase<Ticket> {
    ...
    public final ListPath<com.park.muscle.core.lesson.domain.Lesson, com.park.muscle.core.lesson.domain.QLesson> lesson = this.<com.park.muscle.core.lesson.domain.Lesson, com.park.muscle.core.lesson.domain.QLesson>createList("lesson", com.park.muscle.core.lesson.domain.Lesson.class, com.park.muscle.core.lesson.domain.QLesson.class, PathInits.DIRECT2);
